  ...
  return (
    <div style={s.shell}>
      <aside style={{ ...s.sidebar, width: collapsed ? 64 : 224 }}>
        <div style={s.sideTop}>
          {!collapsed && (
            <img src="/logo.png" alt="Schuber" style={{height:40,objectFit:'contain',maxWidth:130}} />
          )}
          {collapsed && <img src="/logo.png" alt="Schuber" style={{height:30,objectFit:'contain'}} />}
        ...
        <header style={s.header}>
          ...
          <div style={s.headerRight}>
            ...
            <div>
              ...
              <div style={s.headerRole}>{user?.role}</div>
            </div>
          </div>
        </header>
...
const s = {
  ...
  logoText: { fontFamily: "'Syne', sans-serif", fontWeight: 800, fontSize: '1.25rem', color: '#1C1917' },
  logoHub: { background: '#F59E0B', color: '#fff', padding: '1px 4px', borderRadius: 4 },
  ...
  navItem: { display: 'flex', alignItems: 'center', gap: '0.625rem', padding: '0.6rem 0.75rem', borderRadius: 10, color: '#78716C', fontSize: '0.875rem', fontWeight: 500, transition: 'all 0.15s', textDecoration: 'none' },
  ...
  logoutBtn: { background: '#FEF3C7', border: '1px solid #FDE68A', color: '#92400E', padding: '0.4rem 0.75rem', borderRadius: 7, fontSize: '0.78rem', cursor: 'pointer', textAlign: 'left' },
  ...
  pageTitle: { fontFamily: "'Syne', sans-serif", fontWeight: 700, fontSize: '1.2rem', color: '#1C1917' },
  headerRight: { display: 'flex', alignItems: 'center', gap: '0.75rem' },
  headerAvatar: { width: 34, height: 34, borderRadius: '50%', background: '#F59E0B', color: '#fff', display: 'flex', alignItems: 'center', justifyContent: 'center', fontWeight: 700, fontSize: '0.78rem' },
