...
const s = {
  page: { background: '#FFFBF0', minHeight: '100vh', fontFamily: " 'Plus Jakarta Sans', sans-serif" },
  ...
  logoText: { fontFamily: " 'Plus Jakarta Sans', sans-serif", fontWeight: 800, fontSize: '1.4rem', color: '#1C1917', letterSpacing: '-0.02em' },
  ...
  heroTitle: { fontFamily: " 'Plus Jakarta Sans', sans-serif", fontSize: 'clamp(2.5rem,5vw,3.75rem)', fontWeight: 800, lineHeight: 1.1, marginBottom: '1.25rem', color: '#1C1917' },
  ...
  mockupTitle: { fontFamily: " 'Plus Jakarta Sans', sans-serif", fontWeight: 700, fontSize: '0.9rem', color: '#1C1917' },
  ...
  statNum: { fontFamily: " 'Plus Jakarta Sans', sans-serif", fontSize: '2.25rem', fontWeight: 800, color: '#fff', lineHeight: 1 },
  ...
  sectionTitle: { fontFamily: " 'Plus Jakarta Sans', sans-serif", fontSize: 'clamp(1.875rem,4vw,2.75rem)', fontWeight: 800, marginBottom: '3rem', lineHeight: 1.2, color: '#1C1917' },
  ...
  featTitle: { fontFamily: " 'Plus Jakarta Sans', sans-serif", fontWeight: 700, marginBottom: '0.5rem', fontSize: '1rem', color: '#1C1917' },
  ...
  stepNum: { fontFamily: " 'Plus Jakarta Sans', sans-serif", fontSize: '2.75rem', fontWeight: 800, color: 'rgba(245,158,11,0.2)', lineHeight: 1, marginBottom: '0.5rem' },
  stepTitle: { fontFamily: " 'Plus Jakarta Sans', sans-serif", fontWeight: 700, marginBottom: '0.5rem', fontSize: '1rem', color: '#1C1917' },
  ...
  roleTitle: { fontFamily: " 'Plus Jakarta Sans', sans-serif", fontWeight: 800, fontSize: '1.4rem', color: '#1C1917' },
