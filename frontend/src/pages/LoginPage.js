...
const s = {
  ...
  logo:       { display:'block', fontFamily:"'Plus Jakarta Sans',sans-serif", fontWeight:800, fontSize:'1.4rem', color:'#1C1917', textDecoration:'none', marginBottom:'1.75rem' },
  heading:    { fontFamily:"'Plus Jakarta Sans',sans-serif", fontSize:'1.75rem', fontWeight:800, color:'#1C1917', margin:'0 0 0.25rem' },
  ...
  roleTab:    { position:'relative', display:'flex', flexDirection:'column', alignItems:'center', gap:'0.3rem', padding:'0.75rem 0.5rem', borderRadius:12, cursor:'pointer', transition:'all 0.18s', fontFamily:"'Plus Jakarta Sans',sans-serif", fontSize:'0.85rem' },
  ...
  googleBtn:  { width:'100%', display:'flex', alignItems:'center', gap:'0.75rem', padding:'0.9rem 1.25rem', background:'#fff', border:'1.5px solid #E5E7EB', borderRadius:12, fontSize:'0.93rem', fontWeight:700, color:'#1C1917', cursor:'pointer', boxShadow:'0 2px 8px rgba(0,0,0,0.06)', transition:'all 0.2s', fontFamily:"'Plus Jakarta Sans',sans-serif", marginBottom:'1.1rem' },
  ...
  demoBtn:    { width:'100%', display:'flex', alignItems:'center', gap:'0.75rem', padding:'0.9rem 1.25rem', color:'#fff', border:'none', borderRadius:12, fontSize:'0.93rem', fontWeight:700, cursor:'pointer', transition:'all 0.2s', fontFamily:"'Plus Jakarta Sans',sans-serif", marginBottom:'0.6rem' },
  ...
  heroTitle:  { fontFamily:"'Plus Jakarta Sans',sans-serif", fontWeight:800, fontSize:'2rem', color:'#fff', margin:'0 0 0.75rem', lineHeight:1.2 },
  ...
  statVal:    { fontFamily:"'Plus Jakarta Sans',sans-serif", fontWeight:800, fontSize:'1.1rem', color:'#fff' },
